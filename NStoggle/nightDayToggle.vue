...
const i18nRoute = "unit.nightDayToggle";
...
watch(() => state.value, (newVal, oldVal) => {
    $el.value.setAttribute("aria-pressed", !!newVal);
});
...
<template>
    <button ref="$el" class="toggle" aria-pressed="false" title="Toggle Dark Mode" @click="toggleState()">
